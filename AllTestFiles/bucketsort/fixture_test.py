...
def get_data():
    working_file = open("/Users/wuyuxuan/research-local/QuixBugs/json_testcases/"+"bucketsort"+".json", 'r')
...
def test_(line_fixture):
    ...
    assert bucketsort(line_fixture[0][0], line_fixture[0][1]) == line_fixture[1]
